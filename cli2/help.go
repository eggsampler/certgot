...
type HelpCategory struct {
	...
	// Description is a longer text block which can be used to show longer information about the category
	Description string
...
func DefaultHelpPrinter(ctx *Context, requestedCategory string) {
	...
	if requestedCategory != "" && cmd == nil && category == nil {
...
func printHelpCategory(ctx *Context, category *HelpCategory) {
	...
	if category.Description != "" {
		if len(category.Description) < termWidth*2 {
