...
var g = &grammar{
	rules: []*rule{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&litMatcher{
							pos:        position{line: 15, col: 32, offset: 209},
							val:        "#",
							ignoreCase: false,
							want:       "\"#\"",
						},
						&labeledExpr{
							pos:   position{line: 15, col: 36, offset: 213},
							label: "comment",
							expr: &ruleRefExpr{
								pos:  position{line: 15, col: 44, offset: 221},
								name: "CommentText",
							},
						},
					},
		...
		},
		{
			...
			pos:         position{line: 20, col: 1, offset: 308},
			expr: &actionExpr{
				pos: position{line: 20, col: 36, offset: 343},
